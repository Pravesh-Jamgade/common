...
class RoutineTracer;
class MemoryTracker;
namespace ParametricDramDirectoryMSI {class PhysicalMemoryAllocator; }
namespace ParametricDramDirectoryMSI {class Utopia;}
...
private:
   ...
   // std::unordered_map<UInt64, UInt64> virtual_position_megapage; 
